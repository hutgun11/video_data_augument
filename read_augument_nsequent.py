...
def gaussian_blur(image_RGB,path_blur,path):
    ...
    guassain_blur_img.save(path.replace('.jpg','')+'_blur_2_floor.jpg') 
...
def brightness(image_RGB,path_bright,path):
    ...
    bright_img.save(path.replace('.jpg','')+'_bright_2_floor.jpg') 
...
def gaussian_noise(image_RGB,path_gaussian,path):
    ...
    gauss_img.save(path.replace('.jpg','')+'_gaussian_2_floor.jpg') 
